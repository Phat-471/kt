      ...
      <div className="bg-gradient-to-r from-indigo-900 via-violet-900 to-indigo-900 text-white px-5 py-4 rounded-2xl border border-indigo-500/20 shadow-sm">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-white text-indigo-800 rounded-xl text-xs font-bold hover:bg-indigo-50 transition-all active:scale-95 cursor-pointer"
          >
        ...
        <div className="bg-white dark:bg-slate-900 border border-indigo-200 dark:border-indigo-500/30 rounded-2xl p-5 space-y-4 shadow-md">
          ...
          <div className="flex items-center gap-3 pt-2">
            <button
              ...
              className="px-5 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold rounded-xl transition-all active:scale-95 cursor-pointer"
            >
              Lập Phiếu Điều Chỉnh
            </button>
            <button
              onClick={() => setShowCreateForm(false)}
              className="px-4 py-2 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 text-xs font-bold rounded-xl hover:bg-slate-200 dark:hover:bg-slate-700 transition-all cursor-pointer"
            >
              Hủy
            </button>
          </div>
                    ...
                    {entry.status === 'PENDING' && (
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="flex items-center gap-1 px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-lg transition-all active:scale-95 cursor-pointer"
                        >
                          <CheckCircle2 className="w-3.5 h-3.5" /> Phê Duyệt
                        </button>
                        <button
                          onClick={() => handleReject(entry.id)}
                          className="flex items-center gap-1 px-3 py-1.5 bg-rose-100 dark:bg-rose-500/20 hover:bg-rose-200 dark:hover:bg-rose-500/30 text-rose-700 dark:text-rose-300 text-xs font-bold rounded-lg transition-all active:scale-95 cursor-pointer"
                        >
