...
color 0a
echo ========================================================
echo   DONG GOI PHAN MEM KTCD HP v1.3.5
...
copy /y "release\KTCD-HP-Setup-v1.3.5.exe" "%~dp0KTCD-HP-Setup-v1.3.5.exe"

echo.
echo ========================================================
echo   HOAN TAT DONG GOI FILE CAI DAT (.EXE)!
echo   File cai dat duy nhat: KTCD-HP-Setup-v1.3.5.exe
